import { Badge, Box, Button, Flex, Separator, Text, TextArea } from '@radix-ui/themes';
...
export default function Compreviews({ companyId }: { companyId: any }) {
  ...
  return (
    <Box className="w-[90vw] flex flex-col items-end">
      <Flex direction="column" gap="3" mb="5" align={"end"}  className='w-[90%] sm:w-[50%]'>
        <TextArea
      ...
      {companyReview?.length > 0 ? (
        <div className="flex flex-col gap-4">
          {companyReview.map((rev) => (
            ...
            >
              <Badge color='green' className="rounded-xl absolute top-[-10px] left-0 mb-2 block">
